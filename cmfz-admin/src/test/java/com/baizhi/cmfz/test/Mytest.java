...
public class Mytest {
    ...
    public void test2(){
        ...
        Manager manager=new Manager("123","admin",EncryptionUtils.encryptionCodec("123456"+salt),salt,"超级管理员");
    ...
    public void test3(){
        ...
        Manager manager = managerService.login("124", "123456");
        System.out.println(manager);
    }
    ...
    public void test4(){
        ApplicationContext ctx=new ClassPathXmlApplicationContext("classpath:applicationContext.xml");
        ManagerService managerService= (ManagerService) ctx.getBean("managerServiceImpl");
        boolean b = managerService.regist(new Manager("124", "admin2", "123456", null, "管理员"));
        if (b){
